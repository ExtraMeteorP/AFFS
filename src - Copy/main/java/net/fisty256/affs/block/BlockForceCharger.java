...
public class BlockForceCharger extends BlockContainer {
	public BlockForceCharger(Material materialIn)
	{
		super(materialIn);
		this.setHardness(6f);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
		...
		if (te != null)
		{
			playerIn.openGui(AFFS.instance, GUIReferences.ID_FORCE_CHARGER, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
	...
	{
		return new TileEntityForceCharger();
	}
}