...
public class ContainerForceCharger extends Container {
	protected InventoryPlayer playerInv;
	protected int inventorySize = 2;
	protected TileEntity te;
	
	public ContainerForceCharger(EntityPlayer player, TileEntity te)
	{
		this.playerInv = player.inventory;
		this.te = te;
		
		addSlotToContainer(new SlotLinkCard((IInventory) te, 0, 11, 54));
		addSlotToContainer(new SlotEnergyStorageItem((IInventory) te, 1, 11, 18));
