...
public class BlockAreaProtector extends BlockContainer {
	public BlockAreaProtector(Material materialIn)
	{
		super(materialIn);
		this.setHardness(6f);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
		...
		if (te != null)
		{
			playerIn.openGui(AFFS.instance, GUIReferences.ID_AREA_PROTECTOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        TileEntityConfigurator te = (TileEntityConfigurator)worldIn.getTileEntity(pos);
