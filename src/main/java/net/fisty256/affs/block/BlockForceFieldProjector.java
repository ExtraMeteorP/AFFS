...
public class BlockForceFieldProjector extends BlockContainer {
	public BlockForceFieldProjector(Material materialIn)
	{
		super(materialIn);
		this.setHardness(8f);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
		...
		if (te != null)
		{
			playerIn.openGui(AFFS.instance, GUIReferences.ID_FORCE_FIELD_PROJECTOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
