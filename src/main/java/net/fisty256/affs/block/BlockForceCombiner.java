...
public class BlockForceCombiner extends BlockContainer {
	public BlockForceCombiner(Material materialIn)
	{
		super(materialIn);
		this.setHardness(6f);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
		...
		if (te != null)
		{
			playerIn.openGui(AFFS.instance, GUIReferences.ID_FORCE_COMBINER, worldIn, pos.getX(), pos.getY(), pos.getZ());
			return true;
		}
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        TileEntityForceCombiner te = (TileEntityForceCombiner)worldIn.getTileEntity(pos);
	...
	{
		return new TileEntityForceCombiner();
	}
}