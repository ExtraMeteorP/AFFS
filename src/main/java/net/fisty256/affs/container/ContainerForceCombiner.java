...
public class ContainerForceCombiner extends Container {
	protected InventoryPlayer playerInv;
	protected int inventorySize = 2;
	protected TileEntity te;
	
	public ContainerForceCombiner(EntityPlayer player, TileEntity te)
	{
		this.playerInv = player.inventory;
		this.te = te;
		
		addSlotToContainer(new SlotLinkCard((IInventory) te, 0, 8, 6));
		addSlotToContainer(new SlotLinkCard((IInventory) te, 1, 8, 26));
		addSlotToContainer(new SlotLinkCard((IInventory) te, 2, 8, 46));
